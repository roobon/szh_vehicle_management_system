...
--
-- Host: localhost
-- Generation Time: Dec 04, 2022 at 09:01 PM
...
--
-- Database: `szh_vehicle_management_system`
--
...
--
ALTER TABLE `bill`
  MODIFY `bill_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `booking`
--
ALTER TABLE `booking`
  MODIFY `booking_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT for table `driver`
--
ALTER TABLE `driver`
  MODIFY `driverid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `vehicle`
  MODIFY `veh_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
COMMIT;
